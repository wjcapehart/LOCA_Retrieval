...
then
  ...
  echo Working on ${HOST_NAME} using ${OS_NAME}
   ...
   #
  #    max_lat =  38.5 ; degrees north
  #    min_lat =  37.5 ; degrees north
  #    min_lon = -119.5 + 360 ; degrees east
  #    max_lon = -118.25 + 360 ; degrees east
#
#      lon = f->lon
#      lat = f->lat
#
...
##     index_yn = ind(lat .eq. lat({min_lat}))
  ...
  #   print("LATCLIP=  [" +  (index_yn) + ":1:" + (index_yx) + "] [" +  lat(index_yn) + ":1:" + lat(index_yx) + "]")
   ...
   ### NGP
   export LONCLIP="[103:1:123]"   # [187:1:636] # [-114.28125 : 1 : -86.28125]
   export LATCLIP="[225:1:241]"   #  [169:1:470]  # [  33.96875 : 1 :  52.71875]
   ...
   export CLIPPED_WORKDIR="/projects/ECEP/LOCA_MACA_Ensembles/LOCA/LOCA_OUTPUT/grid_mono"
   mkdir -vp ${CLIPPED_WORKDIR}

   export CLIPPED_PREFIX=${CLIPPED_WORKDIR}"/NGP_MONO"
                  ...
                  if [ ! -f ${FILENAME} ]; then
                     ...
                     then
                       ...
                       rm  ./nccopy.log
                        ...
                        echo
                        echo Patching if needed for ${VARNAME} ${UNITS} ${FILLVALUE}
                        echo
